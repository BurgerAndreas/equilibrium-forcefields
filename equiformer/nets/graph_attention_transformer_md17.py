...
@register_model
def graph_attention_transformer_nonlinear_l2_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_l2_e3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_bessel_l2_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_exp_l2_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_exp_l3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_attn_exp_l3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_exp_l3_e3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
    ...
    basis_type="exp",
    irreps_feature="512x0e",
    irreps_head="32x0e+16x0o+8x1e+8x1o+8x2e+8x2o+4x3e+4x3o",
    num_heads=4,
    irreps_pre_attn=None,
    rescale_degree=False,
    nonlinear_message=True,
...
@register_model
def graph_attention_transformer_nonlinear_bessel_l3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,
...
@register_model
def graph_attention_transformer_nonlinear_bessel_l3_e3_md17(
    irreps_in,
    radius,
    number_of_basis=128,
    atomref=None,

...
"""
usage: 
main_oc20.py [-h] --mode {train,predict,run-relaxations,validate} --config-yml CONFIG_YML
[--identifier IDENTIFIER] [--debug] [--run-dir RUN_DIR] [--print-every PRINT_EVERY]
[--seed SEED] [--amp] [--checkpoint CHECKPOINT] [--timestamp-id TIMESTAMP_ID]
[--sweep-yml SWEEP_YML] [--submit] [--summit] [--logdir LOGDIR]
[--slurm-partition SLURM_PARTITION] [--slurm-mem SLURM_MEM] [--slurm-timeout SLURM_TIMEOUT]
[--num-gpus NUM_GPUS] [--distributed] [--cpu] [--num-nodes NUM_NODES]
[--distributed-port DISTRIBUTED_PORT] [--distributed-backend DISTRIBUTED_BACKEND]
[--local_rank LOCAL_RANK] [--no-ddp] [--gp-gpus GP_GPUS]
"""

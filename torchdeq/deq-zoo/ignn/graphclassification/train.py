...
parser.add_argument("--dataset", type=str, default="PROTEINS", help="Dataset to use.")
parser.add_argument(
    "--fold_idx", type=int, default=0, help="Which fold is chosen for test (0-9)."
)
    ...
    def train(epoch):
        ...
        for data in train_loader:
            ...
            adj = torch.sparse.FloatTensor(
                torch.LongTensor(np.array([adj_sp_nz.row, adj_sp_nz.col])).cuda(),
                torch.Tensor(adj_sp_nz.data).cuda(),

...
parser.add_argument("--id", type=str, default="torchdeq", help="experiment id")

parser.add_argument(
    "--eval", action="store_true", default=False, help="Evaluate models."
)
...
parser.add_argument(
    "--resume_path", type=str, default="", help="resume checkpoints from the given path"
)
parser.add_argument(
    "--resume_epoch", type=int, default=0, help="starting training epoch (default to 0)"
)
...
parser.add_argument(
    "--degree", type=int, default=2, help="degree of the approximation."
)
parser.add_argument(
    "--per", type=int, default=-1, help="Number of each nodes so as to balance."
)
...
def train():
    ...
    for data in train_loader:
        ...
        adj = torch.sparse.FloatTensor(
            data.edge_index, edge_weight, torch.Size([data.num_nodes, data.num_nodes])
        )
...
if args.eval:
    ...
    for epoch in range(1, int(args.epochs) + 1):
        ...
        print(
            "Epoch: {:02d}, Loss: {:.4f}, Val: {:.4f}, Test: {:.4f}".format(

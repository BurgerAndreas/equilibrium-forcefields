...
parser.add_argument("--dataset", type=str, default="amazon-all", help="Dataset to use.")
parser.add_argument(
    "--feature",
    type=str,
    default="mul",
...
parser.add_argument(
    "--experiment", type=str, default="base-experiment", help="feature-type"
)
...
if args.dataset == "amazon-all" or args.dataset == "amazon-top5000":
    ...
    (
        ...
        num_nodes,
        num_class,
    ) = load_txt_data(args.dataset, portion)
else:

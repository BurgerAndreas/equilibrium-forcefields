...
class MDEQNet(nn.Module):
    def __init__(self, args, bn_momentum=0.1):
        ...
        self.downsample = nn.Sequential(
            conv3x3(
                3, self.init_chansize, stride=(2 if self.downsample_times >= 1 else 1)
            ),
        ...
        self.full_stage = MDEQModule(
            self.num_branches, BasicBlock, self.num_blocks, self.num_channels
        )
